...
<footer className=" shadow-2xl bg-white px-8  mt-20">
    <div className="w-full   ">
        <div className=" flex flex-col md:flex-row md:items-center md:justify-center md:gap-96">
            <a href="" className="pt-5 mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
         <span className="self-center text-2xl font-bold whitespace-nowrap ">Logo</span>
            </a>
        ...
        <span className="block text-sm text-gray-500 pb-8 text-center ">© 2024 <a href="" className="hover:underline">Health Care</a>. All Rights Reserved.</span>
    </div>
</footer>
</div>
  )
